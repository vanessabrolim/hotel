...
urlpatterns = patterns(
    ...
    url(r'^relatorios/estadiaAnimal/$', 'hotel.relatorios.EstadiaAnimal',
        name='nEstadiaAnimal'),
    url(r'^relatorios/detalheAnimal/(?P<id>.*)$',
        'hotel.relatorios.DetalheAnimal', name='nDetalheAnimal'),
    url(r'^relatorios/pessoaInicial/$', 'hotel.relatorios.PessoaInicial',
        name='nPessoaInicial'),
    url(r'^relatorios/detalhePessoa/(?P<id>.*)$',
        'hotel.relatorios.DetalhePessoa', name='nDetalhePessoa'),
    ...
    url(r'^editar/animal/secundario/(?P<cpf>.*)/?/$',
        'hotel.edicoes.EditarAnimalSecundario',
        name='nEditarAnimalSecundario'),
    ...
    url(r'^editar/estadia/secundario/(?P<cpf>.*)/?/$',
        'hotel.edicoes.EditaEstadiaSecundario',
